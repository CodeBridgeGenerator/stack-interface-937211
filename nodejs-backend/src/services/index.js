...
const stackschema = require("./stackschema/stackschema.service.js");
const stackValidate = require("./stackValidate/stackValidate.service.js");
const stackName = require("./stackName/stackName.service.js");
const appvalidate = require("./appvalidate/appvalidate.service.js");
const pathToLogo = require("./pathToLogo/pathToLogo.service.js");
const appGenTemp = require("./appGenTemp/appGenTemp.service.js");
const serviceGenTemp = require("./serviceGenTemp/serviceGenTemp.service.js");
const schemaGenTemp = require("./schemaGenTemp/schemaGenTemp.service.js");
const configFilePath = require("./configFilePath/configFilePath.service.js");
const schema = require("./schema/schema.service.js");
const schemaPathLogo = require("./schemaPathLogo/schemaPathLogo.service.js");
...
module.exports = function (app) {
  ...
  app.configure(stackschema);
  app.configure(stackValidate);
  app.configure(stackName);
  app.configure(appvalidate);
  app.configure(pathToLogo);
  app.configure(appGenTemp);
  app.configure(serviceGenTemp);
  app.configure(schemaGenTemp);
  app.configure(configFilePath);
  app.configure(schema);
  app.configure(schemaPathLogo);
