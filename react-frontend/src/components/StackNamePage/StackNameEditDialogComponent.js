...
const StackNameCreateDialogComponent = (props) => {
...
appName: _entity?.appName,
        ...
        await client.service("stackName").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info stackName updated successfully" });
    ...
    return (
        <Dialog header="Edit StackName" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="stackName-edit-dialog-component">
...
<div className="col-12 md:col-6 field mt-5">
        <span className="align-items-center">
            ...
            <InputText id="appName" className="w-full mb-3 p-inputtext-sm" value={_entity?.appName} onChange={(e) => setValByKey("appName", e.target.value)}  required  />
        </span>
        </div>
...
export default connect(mapState, mapDispatch)(StackNameCreateDialogComponent);
