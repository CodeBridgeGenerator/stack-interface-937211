...
const SingleDeployJobsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("deployJobs")
            .get(urlParams.singleDeployJobsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">ProjectId</label><p className="m-0 ml-3" >{_entity?.projectId}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Start</label><p id="start" className="m-0 ml-3" >{_entity?.start}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Port</label><p className="m-0 ml-3" >{Number(_entity?.port)}</p></div>
