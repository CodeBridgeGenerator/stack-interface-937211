...
const SingleDeployWorkersPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleDeployWorkersId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Process</label><p className="m-0 ml-3" >{_entity?.process}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Task</label><p className="m-0 ml-3" >{_entity?.task}</p></div>
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm">DeployerJobId</label>
