...
import SingleStackschemaPage from "../components/StackschemaPage/SingleStackschemaPage";
import StackschemaProjectLayoutPage from "../components/StackschemaPage/StackschemaProjectLayoutPage";
import SingleStackValidatePage from "../components/StackValidatePage/SingleStackValidatePage";
import StackValidateProjectLayoutPage from "../components/StackValidatePage/StackValidateProjectLayoutPage";
import SingleStackNamePage from "../components/StackNamePage/SingleStackNamePage";
import StackNameProjectLayoutPage from "../components/StackNamePage/StackNameProjectLayoutPage";
import SingleAppvalidatePage from "../components/AppvalidatePage/SingleAppvalidatePage";
import AppvalidateProjectLayoutPage from "../components/AppvalidatePage/AppvalidateProjectLayoutPage";
import SinglePathToLogoPage from "../components/PathToLogoPage/SinglePathToLogoPage";
import PathToLogoProjectLayoutPage from "../components/PathToLogoPage/PathToLogoProjectLayoutPage";
import SingleAppGenTempPage from "../components/AppGenTempPage/SingleAppGenTempPage";
import AppGenTempProjectLayoutPage from "../components/AppGenTempPage/AppGenTempProjectLayoutPage";
import SingleServiceGenTempPage from "../components/ServiceGenTempPage/SingleServiceGenTempPage";
import ServiceGenTempProjectLayoutPage from "../components/ServiceGenTempPage/ServiceGenTempProjectLayoutPage";
import SingleSchemaGenTempPage from "../components/SchemaGenTempPage/SingleSchemaGenTempPage";
import SchemaGenTempProjectLayoutPage from "../components/SchemaGenTempPage/SchemaGenTempProjectLayoutPage";
import SingleConfigFilePathPage from "../components/ConfigFilePathPage/SingleConfigFilePathPage";
import ConfigFilePathProjectLayoutPage from "../components/ConfigFilePathPage/ConfigFilePathProjectLayoutPage";
import SingleSchemaPage from "../components/SchemaPage/SingleSchemaPage";
import SchemaProjectLayoutPage from "../components/SchemaPage/SchemaProjectLayoutPage";
import SingleSchemaPathLogoPage from "../components/SchemaPathLogoPage/SingleSchemaPathLogoPage";
import SchemaPathLogoProjectLayoutPage from "../components/SchemaPathLogoPage/SchemaPathLogoProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/stackschema/:singleStackschemaId" exact element={<SingleStackschemaPage />} />
<Route path="/stackschema" exact element={<StackschemaProjectLayoutPage />} />
<Route path="/stackValidate/:singleStackValidateId" exact element={<SingleStackValidatePage />} />
<Route path="/stackValidate" exact element={<StackValidateProjectLayoutPage />} />
<Route path="/stackName/:singleStackNameId" exact element={<SingleStackNamePage />} />
<Route path="/stackName" exact element={<StackNameProjectLayoutPage />} />
<Route path="/appvalidate/:singleAppvalidateId" exact element={<SingleAppvalidatePage />} />
<Route path="/appvalidate" exact element={<AppvalidateProjectLayoutPage />} />
<Route path="/pathToLogo/:singlePathToLogoId" exact element={<SinglePathToLogoPage />} />
<Route path="/pathToLogo" exact element={<PathToLogoProjectLayoutPage />} />
<Route path="/appGenTemp/:singleAppGenTempId" exact element={<SingleAppGenTempPage />} />
<Route path="/appGenTemp" exact element={<AppGenTempProjectLayoutPage />} />
<Route path="/serviceGenTemp/:singleServiceGenTempId" exact element={<SingleServiceGenTempPage />} />
<Route path="/serviceGenTemp" exact element={<ServiceGenTempProjectLayoutPage />} />
<Route path="/schemaGenTemp/:singleSchemaGenTempId" exact element={<SingleSchemaGenTempPage />} />
<Route path="/schemaGenTemp" exact element={<SchemaGenTempProjectLayoutPage />} />
<Route path="/configFilePath/:singleConfigFilePathId" exact element={<SingleConfigFilePathPage />} />
<Route path="/configFilePath" exact element={<ConfigFilePathProjectLayoutPage />} />
<Route path="/schema/:singleSchemaId" exact element={<SingleSchemaPage />} />
<Route path="/schema" exact element={<SchemaProjectLayoutPage />} />
<Route path="/schemaPathLogo/:singleSchemaPathLogoId" exact element={<SingleSchemaPathLogoPage />} />
<Route path="/schemaPathLogo" exact element={<SchemaPathLogoProjectLayoutPage />} />
